...
const header = () => {
    ...
    return (
        <div className='flex flex-col items-center mt-20 px-4 text-center'>
            ...
            <h1 className='flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2'>Hello {userData ? userData.name : 'Developer'}!  <img src={assets.hand_wave} className='w-8 aspect-square' alt='' /></h1>
